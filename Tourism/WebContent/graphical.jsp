...
<div class="row">
	<div class="col-md-4">
		<div class="col-md-10 col-md-offset-2">
			...
			<form>
				<div>
					<select class="selectpicker" title="Choisir un pays"
						id="countrySelect">
						<%
				...
				<br>
				<div>
					<select class="selectpicker" title="Choisir un autre pays"
						id="countrySelect2">
						<%
				...
				<br>
				<div>
					<input type="checkbox" id="checkbox1" checked disabled>Arrivées
					(Millions)
				</div>

				<br>
				<div>
					<input type="checkbox" id="checkbox2" checked disabled>Recettes
					(Millions)
				</div>
				...
				<div class="col-md-8">
					...
					<div class="collapse" id="collapseExample">
						<br>
						<div>
							<input type="checkbox"> Toutes les données
						</div>
						<div>
							<input type="checkbox" id="checkCompa"> Comparaison dans
							le monde
						</div>
					</div>
				</div>
					...
					function refreshTable() {
						...
						for (var i = 0; i < tourists1.length; i++) {
							tableBody = tableBody + "<tr>" + "<td>"
									+ tourists1[i].category + "</td>" + "<td>"
									+ tourists1[i].options.y + "</td>" + "<td>"
									+ incomes1[i].options.y + "</td>" + "<td>"
									+ tourists2[i].options.y + "</td>" + "<td>"
									+ incomes2[i].options.y + "</td>" + "</tr>";
						}
