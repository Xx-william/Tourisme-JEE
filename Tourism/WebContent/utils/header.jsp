...
<script src="/Tourism/ETC/bootstrap-select/js/bootstrap-select.js"></script>
<link rel="stylesheet"
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-right">
			<a class="btn btn-info btn-sm navbar-btn"
				href="<%=request.getContextPath()%>/graphical.jsp">Aperçu
				Graphique</a> <a class="btn btn-info btn-sm navbar-btn"
				href="<%=request.getContextPath()%>/map.jsp">Carte du Monde</a>
		</div>
